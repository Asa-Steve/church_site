...
const Home = () => {
  ...
  <g fill="none" fill-rule="evenodd" transform="translate(.75 .75)">
    ...
    <section className='priests'>
      <span className='diff'>TEAM</span>
      <div className=''>Our Priests</div>
      <div className='priest'>
          <div className='priest-card'>
            <img src='./imgs/kids.jpg' />
          </div>
          <div className='priest-name'>
            <h3>Fr.Bruno D.</h3>
            <div className='socials'>
              <div className='social'></div>
            </div>
            <p>Sed nisl velit, varius a retrum eu, varius tincidunt metus.</p>
