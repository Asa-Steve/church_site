        ...
        <div>
            <section className="hero flex-me overlay">
                <div className="left">
                    ...
                    <p>Join us as we journey together in worship, love, and service. Be part of a vibrant community where everyone belongs.</p>
                    ...
                    <div className='item'>
                        <div className='icon'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="52" height="53" viewBox="0 0 52 53">
                                <g fill="none" fillRule="evenodd" transform="translate(.75 .945)">
                        ...
                        <div className='icon'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="46" height="53" viewBox="0 0 46 53">
                                <g fill="none" fillRule="evenodd" transform="translate(.75)">
                                    ...
                                    <path fill="#000" fillRule="nonzero" d="M22.25,11 C13.2753728,11 6,18.2753728 6,27.25 L6,42.25 C6,44.5972102 7.90278981,46.5 10.25,46.5 L34.25,46.5 C36.5972102,46.5 38.5,44.5972102 38.5,42.25 L38.5,27.25 C38.5,18.2753728 31.2246272,11 22.25,11 Z M22.25,13.5 C29.8439153,13.5 36,19.6560847 36,27.25 L36,42.25 C36,43.2164983 35.2164983,44 34.25,44 L10.25,44 C9.28350169,44 8.5,43.2164983 8.5,42.25 L8.5,27.25 C8.5,19.6560847 14.6560847,13.5 22.25,13.5 Z" />
                ...
                <div className='programs'>
                    <div className='program'>
                        ...
                        <div className='program-txt'>
                            ...
                            <p>Sed nisl velit, varius a retrum eu, varius tincidunt metus. Sed tincidunt aliquam nibh at pulvinar.</p>
            ...
            <section className="faq">
                ...
                <div className="wrapper">
                    ...
                    <div className="right">
                        ...
                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Beatae voluptatum voluptatem esse dolores aut est nostrum expedita veniam temporibus sunt! Quidem deserunt nulla eligendi itaque cumque dicta velit voluptatum repudiandae!</p>
